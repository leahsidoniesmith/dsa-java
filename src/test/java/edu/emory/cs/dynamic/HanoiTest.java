...
public class HanoiTest {
    ...
    public void compare() {
        ...
        dynamic.solve(10, source, intermediate, destination);
       // recursive.solve(2, source, intermediate, destination);
       // recursive.solve(3, source, intermediate, destination);
        //recursive.solve(4, source, intermediate, destination);
