...
public class TrieQuizTest {
    ...
    public void testGetEntities() {
        final List<String> L = List.of("United States", "South Korea", "Japan");
        TrieQuiz trie = new TrieQuiz();
        for (int i = 0; i < L.size(); i++)
            trie.put(L.get(i), i);

        String input = "I was born in South Korea and raised in the United States. Japanese food is yummy.";
        List<Entity> entities = List.of(new Entity(44, 57, 0), new Entity(14, 25, 1), new Entity(59, 64, 2));
