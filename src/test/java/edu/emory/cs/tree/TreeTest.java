...
public class TreeTest {
    ...
    public void testQuiz() {
        System.out.println("tests for quiz");
        ...
        tree.add(5);
        tree.add(4);
        System.out.println("case 1:   " + tree.toString());
        ...
        tree.add(4);
        tree.add(5);
        System.out.println("case 4:   " + tree.toString());
        ...
        tree.add(4);
        tree.add(5);
        System.out.println("case 2:   " + tree.toString());
        ...
        tree.add(5);
        tree.add(4);
        System.out.println("case 3:   " + tree.toString());
