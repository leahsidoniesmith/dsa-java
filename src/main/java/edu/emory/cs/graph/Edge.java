...
public class Edge implements Comparable<Edge> {
    ...
    public Edge(int source, int target) { //constructor overriding
    ...
    public int compareTo(Edge edge) {
        ...
        if (diff > 0) return 1; //return 1 is the weight of this edge is greater
        else if (diff < 0) return -1;
        else return 0; //weights are the same
    }
