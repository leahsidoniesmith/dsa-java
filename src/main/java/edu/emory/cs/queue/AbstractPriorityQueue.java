...
public abstract class AbstractPriorityQueue<T extends Comparable<T>> {
     ...
     * @param priority if {@link Comparator#naturalOrder()}, this is a max PQ; (removes key with highest priority)
     *                 if {@link Comparator#reverseOrder()}, this is a min PQ. (removes key with lowest priority)
     */
